...
// jadwalKuliah.getRuangan().getHari(), jadwalKuliah.getMatakuliah().getNamaMatakuliah(),
// jadwalKuliah.getRuangan().getNomorRuangan(), jadwalKuliah.getRuangan().getWaktuMulai(),
// jadwalKuliah.getRuangan().getWaktuSelesai());
